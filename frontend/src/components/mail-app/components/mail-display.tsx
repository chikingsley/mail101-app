...
interface MailDisplayProps {
  ...
  onReply?: (email: EmailWithFlags) => void;
  onReplyAll?: (email: EmailWithFlags) => void;
  onForward?: (email: EmailWithFlags) => void;
}
                ...
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    ...
                    {mail?.flagStatus === "flagged" && mail?.flagColor && (
                      <span
                        className={`absolute -top-0.5 -right-0.5 h-2.5 w-2.5 rounded-full ${getFlagColorClass()}`}
                      />
                    )}
